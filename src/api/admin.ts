  ...
  try {
    ...
    if (apiErr?.status === 404 || apiErr?.message?.includes('fetch')) {
      const mock: AdminUser[] = [
        ...
        { user_id: '2', username: 'jane', email: 'jane@example.com', role: 'user', status: 'active', created_at: '2024-02-01T14:30:00Z' },
        { user_id: '3', username: 'bob', email: 'bob@example.com', role: 'user', status: 'suspended', created_at: '2024-02-10T09:00:00Z' },
        { user_id: '4', username: 'guest1', email: 'guest@example.com', role: 'guest', status: 'active', created_at: '2024-02-15T11:00:00Z' },
      ]
