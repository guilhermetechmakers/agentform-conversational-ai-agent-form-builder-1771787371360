...
const PROVIDER_CONFIG = {
  google: {
    ...
    className: 'border-border hover:bg-[#f8f9fa] hover:border-[#dadce0]',
  },
  microsoft: {
    label: 'Microsoft',
    icon: (
    ...
    className: 'border-border hover:bg-[#f5f5f5] hover:border-[#e0e0e0]',
  },
  github: {
    label: 'GitHub',
    icon: (
    ...
    className: 'border-border hover:bg-[#f6f8fa] hover:border-[#d0d7de]',
  },
} as const
